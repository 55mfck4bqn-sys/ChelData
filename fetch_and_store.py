...
def main():
    ...
    # 1) Club stats (also used to derive club name if present)
    ...
    if isinstance(stats_json, dict):
        ...
        elif "data" in stats_json and isinstance(stats_json["data"], list) and stats_json["data"]:
